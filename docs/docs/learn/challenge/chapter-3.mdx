...
(24 hours) arithmetics using the function [modulo()](https://docs.camunda.io/docs/components/modeler/feel/builtin-functions/feel-built-in-functions-numeric#modulodividend-divisor).
