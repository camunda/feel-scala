---
id: tutorial-1-1
title: "1.1 First stop: Numeric expressions"
---
...
Using numeric functions, how many hours would it take to get there? Consider resting for 30 minutes every 5 hours (Let's also round up the number for total resting time)
