...
/** @author
  *   Philipp Ossler
  */
class InterpreterDateTimeExpressionTest extends AnyFlatSpec with Matchers with FeelIntegrationTest {
  ...
  it should "compare with 'between _ and _'" in {
    ...
    eval(
      """ time("08:30:00+01:00") between time("08:00:00+01:00") and time("10:00:00+01:00") """
    ) should be(ValBoolean(true))
    eval(
      """ time("08:30:00+01:00") between time("09:00:00+01:00") and time("10:00:00+01:00") """
  ...
  it should "subtract date from date as string" in {
    ...
    eval(""" string(date("2020-04-07") - date("2020-04-01")) """) should be(ValString("P6D"))
  }
  ...
  it should "compare with 'between _ and _'" in {
    ...
    eval(""" date("2017-01-10") between date("2017-01-01") and date("2018-01-10") """) should be(
      ValBoolean(true)
    )
    eval(""" date("2017-01-10") between date("2017-02-01") and date("2017-03-01") """) should be(
      ValBoolean(false)
    )
  }
  ...
  "A date-time" should "subtract from another date-time" in {
    ...
    eval(
      """ date and time("2017-01-10T10:30:00") - date and time("2017-01-01T10:00:00") """
    ) should be(ValDayTimeDuration("P9DT30M"))
    eval(
      """ date and time("2017-01-10T10:00:00") - date and time("2017-01-10T10:30:00") """
    ) should be(ValDayTimeDuration("PT-30M"))

    eval(
      """ date and time("2017-01-10T10:30:00+01:00") - date and time("2017-01-01T10:00:00+01:00") """
    ) should be(ValDayTimeDuration("P9DT30M"))
    eval(
      """ date and time("2017-01-10T10:00:00+01:00") - date and time("2017-01-10T10:30:00+01:00") """
    ) should be(ValDayTimeDuration("PT-30M"))
  }
  ...
  it should "compare with '='" in {
    ...
    eval(
      """ date and time("2017-01-10T10:30:00") = date and time("2017-01-10T10:30:00") """
    ) should be(ValBoolean(true))
    eval(
      """ date and time("2017-01-10T10:30:00") = date and time("2017-01-10T14:00:00") """
    ) should be(ValBoolean(false))

    eval(
      """ date and time("2017-01-10T10:30:00+01:00") = date and time("2017-01-10T10:30:00+01:00") """
    ) should be(ValBoolean(true))
    eval(
      """ date and time("2017-01-10T10:30:00+01:00") = date and time("2017-01-10T14:00:00+01:00") """
    ) should be(ValBoolean(false))
  }
  ...
  it should "compare with '!='" in {
    ...
    eval(
      """ date and time("2017-01-10T10:30:00") != date and time("2017-01-11T10:30:00") """
    ) should be(ValBoolean(true))
    ...
    eval(
      """ date and time("2017-01-10T10:30:00+01:00") != date and time("2017-01-11T10:30:00+01:00") """
    ) should be(ValBoolean(true))
  }
  ...
  it should "compare with '<'" in {
    ...
    eval(
      """ date and time("2017-01-10T10:30:00") < date and time("2017-02-10T10:00:00") """
    ) should be(ValBoolean(true))
    eval(
      """ date and time("2017-01-10T10:30:00") < date and time("2017-01-10T10:30:00") """
    ) should be(ValBoolean(false))
    ...
    eval(
      """ date and time("2017-01-10T10:30:00+01:00") < date and time("2017-02-10T10:00:00+01:00") """
    ) should be(ValBoolean(true))
    eval(
      """ date and time("2017-01-10T10:30:00+01:00") < date and time("2017-01-10T10:30:00+01:00") """
    ) should be(ValBoolean(false))
  ...
  it should "compare with '<='" in {
    ...
    eval(
      """ date and time("2017-02-10T10:00:00") <= date and time("2017-01-10T10:30:00") """
    ) should be(ValBoolean(false))
    ...
    eval(
      """ date and time("2017-02-10T10:00:00+01:00") <= date and time("2017-01-10T10:30:00+01:00") """
    ) should be(ValBoolean(false))
  }
  ...
  it should "compare with '>'" in {
    ...
    eval(
      """ date and time("2018-01-10T10:30:00") > date and time("2017-01-10T10:30:00") """
    ) should be(ValBoolean(true))
    ...
    eval(
      """ date and time("2018-01-10T10:30:00+01:00") > date and time("2017-01-10T10:30:00+01:00") """
    ) should be(ValBoolean(true))
  }
  ...
  it should "compare with '>='" in {
    ...
    eval(
      """ date and time("2017-01-10T10:30:00") >= date and time("2017-01-10T10:30:01") """
    ) should be(ValBoolean(false))
    ...
    eval(
      """ date and time("2017-01-10T10:30:00+01:00") >= date and time("2017-01-10T10:30:01+01:00") """
    ) should be(ValBoolean(false))
  }
  ...
  it should "compare with 'between _ and _'" in {
    ...
    eval(
      """ date and time("2017-01-10T10:30:00") between date and time("2017-01-10T09:00:00") and date and time("2017-01-10T14:00:00") """
    ) should be(ValBoolean(true))
    eval(
      """ date and time("2017-01-10T10:30:00") between date and time("2017-01-10T11:00:00") and date and time("2017-01-11T08:00:00") """
    ) should be(ValBoolean(false))

    eval(
      """ date and time("2017-01-10T10:30:00+01:00") between date and time("2017-01-10T09:00:00+01:00") and date and time("2017-01-10T14:00:00+01:00") """
    ) should be(ValBoolean(true))
    eval(
      """ date and time("2017-01-10T10:30:00+01:00") between date and time("2017-01-10T11:00:00+01:00") and date and time("2017-01-11T08:00:00+01:00") """
    ) should be(ValBoolean(false))
  }
  ...
  it should "compare with 'between _ and _'" in {
    ...
    eval(""" duration("PT8H") between duration("PT6H") and duration("PT12H") """) should be(
      ValBoolean(true)
    )
    eval(""" duration("PT2H") between duration("PT6H") and duration("PT12H") """) should be(
      ValBoolean(false)
    )
  }
