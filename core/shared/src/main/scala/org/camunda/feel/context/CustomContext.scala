...
/** Override this class if you want to implement a custom Context. Call the corresponding super
  * method to handle the default/error case. Typically you will just override one of the dynamic
  * providers (variableProvider, functionProvider)
  */
